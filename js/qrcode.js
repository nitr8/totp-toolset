...
!(function (r) {
    ...
    function n(r, t, e) {
      ...
      var i = a.measureText(e.label).width,
        ...
        s = l + u,
        v = 0.01;
      1 === e.mode ? r.addBlank(0, l - v, n, s + v) : r.addBlank(c - v, l - v, g + v, s + v), (t.fillStyle = e.fontcolor), (t.font = o), t.fillText(e.label, c * n, l * n + 0.75 * e.mSize * n);
    }
    function o(r, t, e) {
      var n = e.size,
      ...
      var r = (function () {
        ...
        var e = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
          ...
          h = function (r, t, e, n) {
            ...
            var h = "";
            return (
              (h += "<img"), (h += ' src="'), (h += "data:image/gif;base64,"), (h += f), (h += '"'), (h += ' width="'), (h += r), (h += '"'), (h += ' height="'), (h += t), (h += '"'), n && ((h += ' alt="'), (h += n), (h += '"')), (h += "/>")
            );
          };
        return t;
      })();
