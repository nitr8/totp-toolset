...
(function (Y) {
        ...
        if ("SHA-1" === c)
            ...
            if (
                ...
                (u = function (a, b, h, e) {
                    ...
                    else if ("SHA-384" === c || "SHA-512" === c) (k = (((b + 129) >>> 10) << 5) + 31), (f = 32);
    ...
    function P(c, a, b, e) {
        ...
        for (g = 0; g < n; g += 3)
            for (
                d = g + 1 < n ? c[(g + 1) >>> 2] : 0,
                    p = g + 2 < n ? c[(g + 2) >>> 2] : 0,
                    p = (((c[g >>> 2] >>> (8 * (f + (g % 4) * b))) & 255) << 16) | (((d >>> (8 * (f + ((g + 1) % 4) * b))) & 255) << 8) | ((p >>> (8 * (f + ((g + 2) % 4) * b))) & 255),
                    d = 0;
                4 > d;
                d += 1
            )
        ...
        switch (c) {
            ...
            case "TEXT":
                c = function (c, h, d) {
                    ...
                    q = d >>> 3;
                    if ("UTF8" === a)
                        for (t = -1 === b ? 3 : 0, f = 0; f < c.length; f += 1)
                            for (
                                g = c.charCodeAt(f),
                                    l = [],
                                    128 > g
                                        ...
                                        : ((f += 1), (g = 65536 + (((g & 1023) << 10) | (c.charCodeAt(f) & 1023))), l.push(240 | (g >>> 18), 128 | ((g >>> 12) & 63), 128 | ((g >>> 6) & 63), 128 | (g & 63))),
                                    m = 0;
                                m < l.length;
                                m += 1
                            ) {
    ...
    function t(c, a) {
        ...
        return (k =
            32 >= a
                ? new b((k.a >>> a) | ((k.b << (32 - a)) & 4294967295), (k.b >>> a) | ((k.a << (32 - a)) & 4294967295))
                : new b((k.b >>> (a - 32)) | ((k.a << (64 - a)) & 4294967295), (k.a >>> (a - 32)) | ((k.b << (64 - a)) & 4294967295)));
    }
    function T(c, a) {
        var k = null;
    ...
    function A(c) {
        ...
        else if (0 === c.lastIndexOf("SHA3-", 0) || 0 === c.lastIndexOf("SHAKE", 0)) for (c = 0; 5 > c; c += 1) a[c] = [new b(0, 0), new b(0, 0), new b(0, 0), new b(0, 0), new b(0, 0)];
    ...
    function K(c, a) {
        ...
        l = a[4];
        for (f = 0; 80 > f; f += 1)
            (b[f] = 16 > f ? c[f] : y(b[f - 3] ^ b[f - 8] ^ b[f - 14] ^ b[f - 16], 1)),
                (p = 20 > f ? H(y(e, 5), (d & n) ^ (~d & g), l, 1518500249, b[f]) : 40 > f ? H(y(e, 5), d ^ n ^ g, l, 1859775393, b[f]) : 60 > f ? H(y(e, 5), U(d, n, g), l, 2400959708, b[f]) : H(y(e, 5), d ^ n ^ g, l, 3395469782, b[f])),
                (l = g),
                (g = n),
                (n = y(d, 30)),
                (d = e),
    ...
    function L(c, a, k) {
        ...
        f = a[7];
        for (r = 0; r < u; r += 1)
            16 > r ? ((q = r * t), (m = c.length <= q ? 0 : c[q]), (q = c.length <= q + 1 ? 0 : c[q + 1]), (E[r] = new D(m, q))) : (E[r] = w(z(E[r - 2]), E[r - 7], A(E[r - 15]), E[r - 16])),
    ...
    "function" === typeof define && define.amd
        ...
        ? ("undefined" !== typeof module && module.exports && (module.exports = C), (exports = C))
        : (Y.jsSHA = C);
})(this);